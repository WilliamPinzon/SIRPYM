	...
	function generatePDF(event) {
	   ...
	   ["TOTAL BRUTO","IMPO-CONSUMO","SERVICIO INCLUIDO","TOTAL NETO"].forEach(headerText => {
		...
		html2pdf().set({
		    ...
		    //jsPDF: { unit: 'in', format: 'letter', orienta	tion: 'portrait' }
		}).from(container).save();

		
				
		// Función para convertir el contenido del contenedor a PDF y descargarlo
//		function descargarComoPDF() {
//		    // Seleccionar el contenedor que quieres convertir a PDF
//		    const contenedor = document.getElementById("container"); // Reemplaza "container" con el id de tu contenedor
//		    
...
//		    };
//		    
//		    // Convertir el contenido del contenedor a PDF y descargarlo
//		    html2pdf().set(opciones).from(contenedor).save();
//		}

	    // Abrir una ventana emergente para mostrar la previsualización del PDF
//	    const previewWindow = window.open("", "_blank", "width=800,height=600");
//	    previewWindow.document.write("<html><head><title>Previsualización del PDF</title></head><body></body></html>");
//	    previewWindow.document.body.appendChild(container);


//			// Abrir una ventana emergente para mostrar la previsualización del PDF
//			// Calcular las dimensiones de la ventana emergente
//			const width = 900;
//			const height = 600;
//			
...
//			
//			// Abrir una ventana emergente centrada para mostrar la previsualización del PDF
//			const previewWindow = window.open("", "_blank", `width=${width},height=${height},left=${left},top=${top}`);
//
//			previewWindow.document.write("<html><head><title>Previsualización del PDF</title></head><body></body></html>");
//			
//			// Crear el botón de descarga dentro de la ventana emergente
//			const botonDescargarPDF = previewWindow.document.createElement("button");
//			botonDescargarPDF.textContent = "Descargar PDF";
//			
//			// Función para generar y descargar el PDF cuando se hace clic en el botón
...
//			    html2pdf().from(container).save(fechaHoraFormateada + "_" +  numeroidClienteNombre);
//			}
//			
//			// Asignar la función descargarPDF() al evento click del botón
//			botonDescargarPDF.addEventListener("click", descargarPDF);
//			
//			// Agregar el botón a la ventana emergente
//			previewWindow.document.body.appendChild(botonDescargarPDF);
//			
//			// Agregar el contenedor al cuerpo de la ventana emergente
//			previewWindow.document.body.appendChild(container);
...
//			const fechaHoraFormateada = `${fechaFormateada}${horaFormateada}`;
//			
//			console.log(fechaHoraFormateada); // Output: 23022024030548
//	
//	        
//	    html2pdf().from(container).save(fechaHoraFormateada + "_" +  numeroidClienteNombre);
}
