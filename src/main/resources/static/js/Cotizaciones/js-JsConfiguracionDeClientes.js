...
function guardarFila(button) {
	...
	var informacionAdicional = fila.find(".informacionAdicional").val();
	...
	document.getElementById("btn-aceptar").addEventListener("click", function() {
		...
		var informacionAdicionalInput = document.createElement("input");
		informacionAdicionalInput.type = "hidden";
		informacionAdicionalInput.name = "informacionAdicional";
		informacionAdicionalInput.value = informacionAdicional;
		...
		form.appendChild(informacionAdicionalInput);
	...
	document.getElementById("btn-aceptarF").addEventListener("click", function() {
        $.ajax({
            ...
            success: function (data) {
                fila.remove();
                window.location.href = "/ConfiguracionDeClientes?delete";
            },
