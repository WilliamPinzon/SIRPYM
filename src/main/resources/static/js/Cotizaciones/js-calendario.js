const calendario = flatpickr("#mostrarCalendario", {
    ...
    dateFormat: "Y-m-d h:i K", // Formato de fecha y hora (h para formato de 12 horas, K para AM/PM)
    ...
    onReady: function(selectedDates, dateStr, instance) {
        ...
        document.getElementById("btnAceptar").addEventListener("click", function () {
            ...
            if (fechaSeleccionada) {
                const fechaStr = calendario.formatDate(fechaSeleccionada, "Y-m-d h:i K"); // Utilizar el mismo formato que el de la configuración
