...
@Entity
@Table(name = "COTIZACIONES_REGISTRADAS", uniqueConstraints = @UniqueConstraint(columnNames = "ID_COTIZACION"))
public class CotizacionesRegistradas {
	...
	public CotizacionesRegistradas() {
		super();
	}

	public CotizacionesRegistradas(Long id, String numeroDeDocumentoCliente, String nombreCompletoCliente,
	...
	public CotizacionesRegistradas(String numeroDeDocumentoCliente, String nombreCompletoCliente,
